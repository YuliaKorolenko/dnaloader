...
if __name__ == '__main__':
    ...
    # Measure the time
    print("2d with limit: ", get_time(track_2d, random_chr, random_number, random_window))
    print("2d coller: ", get_time(track_2d_coller, random_chr, random_number, random_window))
